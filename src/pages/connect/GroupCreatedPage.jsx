...
import { SafeAreaView, View, Text, TextInput, Image, TouchableOpacity, Keyboard, TouchableWithoutFeedback } from 'react-native';
    ...
    return (
        <TouchableWithoutFeedback onPress={handleKeyboard}>
            <SafeAreaView style={GroupCreatedStyles.container}>
                <TopBar topBar="그룹 채팅방 만들기" color='#000' backgroundColor={CustomTheme.primaryBg} />

                <Text style={GroupCreatedStyles.textTitle}>프로필 사진</Text>
                {image ? (
                    <View style={GroupCreatedStyles.containerImage}>
                        <Image source={{ uri: image }} style={GroupCreatedStyles.imageProfile} />
                        <IconProfileBorder style={GroupCreatedStyles.imageBorder} />
                        <TouchableOpacity onPress={pickImage}>
                            <IconProfileChange />
                        </TouchableOpacity>
                    </View>
                ) : (
                    <TouchableOpacity style={GroupCreatedStyles.containerImage} onPress={pickImage}>
                        <IconProfileUpload />
                    </TouchableOpacity>
                )}
                ...
                <View style={GroupCreatedStyles.containerTextInput}>
                    <TextInput
                        ...
                        maxLength={20}
                    />
                    <Text style={GroupCreatedStyles.textCount}>{nameInput.length} / 20</Text>
                </View>
                ...
                <View style={GroupCreatedStyles.containerTextInput}>
                    ...
                    />
                    <Text style={GroupCreatedStyles.textCount}>{bioInput.length} / 60</Text>
                </View>

                <View style={GroupCreatedStyles.bottomTwoButtons}>
                    <BottomTwoButtons shadow='true'>
                        <View text='뒤로가기' onPress={() => navigation.goBack()} />
                        <View text='다음' onPress={() => navigation.navigate('GroupCreatedDetailPage')}/>
                    </BottomTwoButtons>
                </View>
            </SafeAreaView>
