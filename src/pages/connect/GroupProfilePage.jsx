...
const GroupProfilePage = () => {
    ...
    return (
        <SafeAreaView style={[GroupProfileStyles.container, { alignItems: 'center' }]}>
            <View style={GroupProfileStyles.topBar}>
                <ConnectProfileTopBar topBar="프로필"/>
                <IconHeart24 active={heart} onPress={handleHeartPress}/>
            </View>
            <ScrollView contentContainerStyle={{ alignItems: 'center' }} style={GroupProfileStyles.scrollView}>
                ...
                <View style={GroupProfileStyles.simpleProfileContainer}>
                    ...
                    <Text style={GroupProfileStyles.name}>{profileData.name}</Text>
                    <View style={GroupProfileStyles.containerHeadcount}>
                        <IconGroupHeadcount />
                        <View style={GroupProfileStyles.containerTextHeadcount}>
                            <Text style={GroupProfileStyles.textHeadcount}>{profileData.headcount}</Text>
                            <Text style={GroupProfileStyles.textMaxHeadcount}> / 30</Text>
                        </View>
                    </View>
                </View>
                ...
                <View style={GroupProfileStyles.report} onPress={() => this.setState({open: true})}>
                    <TouchableOpacity onPress={handleReport}>
                        <Text style={GroupProfileStyles.textReport}>신고하기</Text>
                    </TouchableOpacity>
                    <Report
            ...
            <View style={GroupProfileStyles.applyButton}>
                <ApplyButton text="그룹 가입하기" background="true" onPress={handleGroupJoin} />
            </View>
            <ModalGroupJoin
