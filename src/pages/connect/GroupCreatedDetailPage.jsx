...
import { SafeAreaView, View, Text, TextInput, ScrollView, Keyboard, KeyboardAvoidingView, Platform, TouchableWithoutFeedback } from 'react-native';
    ...
    return (
        <TouchableWithoutFeedback onPress={handleKeyboard}>
            <SafeAreaView style={GroupCreatedDetailStyles.container}>
                <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : 'height'} style={GroupCreatedDetailStyles.container}>
                    <TopBar topBar="그룹 채팅방 만들기" color='#000' />
                    <ScrollView>
                        <View style={{marginTop: 26}}>
                            <Text style={GroupCreatedDetailStyles.textGroupChatSetting}>채팅방 설정</Text>
                        </View>

                        <View style={GroupCreatedDetailStyles.containerItem}>
                            <Text style={GroupCreatedDetailStyles.textTitle}>주제</Text>
                            <View style={GroupCreatedDetailStyles.infoTextContainer}>
                                <InfoCircle />
                                <Text style={GroupCreatedDetailStyles.infoText}>최대 4개까지 선택 가능</Text>
                            </View>
                            <View>
                                {hobbyRows.map((row, rowIndex) => (
                                <View key={rowIndex} style={GroupCreatedDetailStyles.containerRow}>
                        ...
                        <View style={GroupCreatedDetailStyles.containerItem}>
                            <Text style={GroupCreatedDetailStyles.textTitle}>언어</Text>
                            <View style={GroupCreatedDetailStyles.infoTextContainer}>
                                <InfoCircle />
                                <Text style={GroupCreatedDetailStyles.infoText}>최대 2개까지 선택 가능</Text>
                            </View>
                        ...
                        <View style={GroupCreatedDetailStyles.containerItem}>
                            <Text style={GroupCreatedDetailStyles.textTitle}>유형</Text>
                            <View style={GroupCreatedDetailStyles.infoTextContainer}>
                                <InfoCircle />
                                <Text style={GroupCreatedDetailStyles.infoText}>최대 2개까지 선택 가능</Text>
                            </View>
                        ...
                        <View style={GroupCreatedDetailStyles.containerItem}>
                            <Text style={GroupCreatedDetailStyles.textTitle}>그룹 멤버 수 제한</Text>
                            <View style={GroupCreatedDetailStyles.containerSlider}>
                                <MultiSlider
                                    ...
                                    snapped
                                />
                                <Text style={GroupCreatedDetailStyles.textHeadcount}>{multiSliderValue[0]} ~ {multiSliderValue[1]}명</Text>
                            </View>
                        </View>

                        <View style={GroupCreatedDetailStyles.containerItem}>
                            <Text style={GroupCreatedDetailStyles.textTitle}>공개 유무</Text>
                            <View style={GroupCreatedDetailStyles.containerRadioButtonGroup}>
                                <RadioButtonGroup
                                    values={reportTypes}
                                    selected={selected}
                                ...
                                {selected === '비공개' && 
                                    <TextInput
                                        style={GroupCreatedDetailStyles.textInputPassword}
                ...
                <View style={GroupCreatedDetailStyles.bottomTwoButtons}>
                    <BottomTwoButtons shadow='true'>
                        ...
                        <View text='다음' onPress={() => navigation.navigate('GroupProfilePreviewPage')} />
                    </BottomTwoButtons>
                </View>
            </SafeAreaView>
