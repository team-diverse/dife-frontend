    ...
    return (
        ...
        >
            <View style={styles.rectangle}>
                <TouchableOpacity style={styles.iconCancelX} onPress={() => setModalVisible(false)}>
                    <IconCancelX />
                </TouchableOpacity>
                {showComplete ? (
                    <>
                    <View style={styles.reportCompleteContainer}>
                        ...
                        <Text style={styles.reportCompleteText}>가입 완료</Text>
                    </View>
                    <TouchableOpacity style={styles.rectangleBlue}>
                        <Text style={styles.textRectangleBlue}>채팅방으로 바로 이동하기</Text>
                    </TouchableOpacity>
                    </>
                ) : (
                    <>
                    ...
                    {incorrectPassword && 
                        <View style={styles.containerError}>
                            ...
                            <Text style={styles.textError}>잘못된 비밀번호입니다</Text>
                        </View>
                    }
                    <Text style={styles.textPassword}>비밀번호를 입력해주세요</Text>
                    <TouchableOpacity style={styles.rectangleBlue} onPress={() => setShowComplete(true)}>
