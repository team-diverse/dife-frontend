                ...
                >
                  ...
                  <ScrollView style={styles.listContainer}>
                    ...
                    <Collapsible collapsed={collapsedStates[0]}>
                      <View>
                        <Text style={styles.textHeadcountCategory}>인원수</Text>
                        ...
                        <MultiSlider
                          ...
                          snapped
                        />
                        <Text style={styles.textHeadcount}>{multiSliderValue[0]} ~ {multiSliderValue[1]}명</Text>
                      </View>
                      </View>
                      <View>
                        <Text style={styles.textHeadcountCategory}>유형</Text>
